...
import com.micro.mall.dto.GoodsExample;
...
public interface UserInfoMapper {
    ...
    Boolean userHasCollect(@Param("user_id") int userId, @Param("goods_id") int goodsId);


    @Insert("insert into user_preference (goods_id, user_id, type)\n" +
            "values (#{goods_id}, #{user_id}, 1);\n")
    void setUserCollect(@Param("user_id") Integer userId, @Param("goods_id") int goodsId);
    ...
    @Delete("delete\n" +
            ...
            "  and user_id = #{user_id}\n" +
            "  and type = 1")
    void deleteUserCollect(@Param("user_id") Integer userId, @Param("goods_id") int goodsId);
    ...
    List<Goods> getUserCollect(@Param("user_id") int userId);
    ...
    List<Goods> getUserBought(@Param("buyer_id") int buyerId);
    ...
    @Select("select id, name, primary_pic_url, price, sold_time\n" +
            ...
            "  and is_selling = 0\n" +
            "order by sold_time desc")
    List<Goods> getUserSold(@Param("seller_id") int sellerId);
    ...
    List<Goods> getUserPosted(@Param("seller_id") int sellerId);
